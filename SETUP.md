...
4. **"Build" → "Firestore Database"** kholein.
   ...
   - Database ban jaye to **"Rules"** tab kholein, jo likha hai usay hata kar ye
     ...
     ```
     **Publish** karein.
5. **"Build" → "Storage"** kholein (ye bills/PDF store karne ke liye hai).
   - **"Get started"** → **"Start in production mode"** → Done.
   - **"Rules"** tab mein ye paste karein:
     ```
     rules_version = '2';
...
7. Is folder mein `firebase-config.js` file kholein, aur jo already likha hai
...
- **Data ab cloud mein hai** — jo bhi ye link aur PIN jaanta hai wo data
  ...
  zaroori na ho.
- **Bills ka size limit** — har PDF 4.5MB tak honi chahiye. Bari file ho to
  pehle kisi free tool (iLovePDF, SmallPDF) se compress kar lein.
